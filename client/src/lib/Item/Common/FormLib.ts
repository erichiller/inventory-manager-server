...
export function applyDefaults<S extends GenericItem> ( 
                                                        fieldValues: ItemGqlWithDefaultField<S>, 
                                                        defaults: Partial<ItemGqlWithDefaultField<S>>,
                                                        overwrite: Partial<ItemGqlWithDefaultField<S>> = {}
                                                        ): ItemGqlWithDefaultField<S> 
{
