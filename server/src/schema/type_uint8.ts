...
/**
 * See [GraphQL-Tools Custom Scalar](https://www.apollographql.com/docs/graphql-tools/scalars/)
 */
...
export default new GraphQLScalarType( {
    name: NAME,
    description: `${NAME} (unsigned int between ${ MIN } and ${ MAX }) scalar type for Apollo GraphQL`,
    serialize ( value ) {
        if (
    ...
    parseValue ( value ) {
        ...
        throw new GraphQLError( `${value} is not a valid `, [] );
    },
    parseLiteral ( ast: IntValueNode ) {
        ...
        throw new GraphQLError( `Invalid ${ NAME } literal.\n${ ast.value } is not ${ NAME }.`, [ ast ] );
    }
} );
